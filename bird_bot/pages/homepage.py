    ...
    def load_tasks(self):
        ...
        try:
            for task in tasks_data:
                tab = TaskTab(task["site"],task["product"],task["profile"],task["monitor_proxies"],task["shopping_proxies"],
                    task["monitor_delay"], task["error_delay"], task["max_price"],task["max_quantity"], self.stop_all_tasks,self.scrollAreaWidgetContents)
