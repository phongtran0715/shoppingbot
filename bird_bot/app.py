...
class MainWindow(QtWidgets.QMainWindow):
	...
	def __init__(self, parent=None):
		...
		db_file = os.path.join('data', 'birdbot_db.sqlite')
		...
		if not os.path.isfile(db_file):
			...
			sys.exit(1)
		db_conn = QSqlDatabase.addDatabase("QSQLITE", "birdbot_db_conn")
		db_conn.setDatabaseName(db_file)
		if not db_conn.open():
			QMessageBox.critical(
				None,
				'Supreme - Error!',
	...
	def setupUi(self, MainWindow):
		...
		MainWindow.setWindowTitle("Bird Bot v1.5")
